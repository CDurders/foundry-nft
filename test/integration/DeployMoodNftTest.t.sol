...
contract MoodNftTest is Test {
    ...
    function testConvertSvgToUri() public view {
        ...
        string memory resultUri = deployer.svgToImageUri(svg);
        
        assert(keccak256(abi.encodePacked(resultUri)) == keccak256(abi.encodePacked(expectedUri)));
    }

        function testDeploysAndReturnsMoodNft() public {
